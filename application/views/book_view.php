                ...
                <div class="box-header">
				  ...
				  <br />
				   <br />
					...
					<button class="btn btn-primary" class="btn btn-danger" onclick="location.href='<?php echo base_url();?>index.php/book/bookadd'"><i class="glyphicon glyphicon-plus"></i> Add Book</button>
				  <br />
                </div><!-- /.box-header -->
                <div class="box-body">
             ...
             <tbody>
				<?php foreach($books as $book){?>
				     <tr>
								...
								<td><?php echo $book->book_descript;?></td>
								<td><?php echo $book->book_date;?></td>
								<td>
									<a href="<?php echo site_url('book/bookedit/'.$book->book_id.''); ?>"><div class="btn btn-warning"><i class="glyphicon glyphicon-pencil"></i></div></a>
